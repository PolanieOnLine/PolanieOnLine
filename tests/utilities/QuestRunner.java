...
public class QuestRunner {
	...
	public static void doQuestBowsForOuchit(final Player player) {
		...
		en.step(player, "wood");
		equipWithItem(player, "końskie włosie");
		en.step(player, "końskie włosie");
		en.step(player, "bye");
		assertEquals("done", player.getQuest(questSlot, 0));
	}
	...
	public static void doQuestElfPrincess(final Player player) {
		...
		en.step(player, "bye");
		en = getSpeakerNPC("Róża Kwiaciarka").getEngine();
		en.step(player, "hi");
		assertEquals(1, player.getNumberOfEquipped("orchidea"));
		en = princess.getEngine();
		en.step(player, "hi");
		en.step(player, "flower");
		assertEquals(0, player.getNumberOfEquipped("orchidea"));
		en.step(player, "bye");
	}
	...
	public static void doQuestGoodiesForRudolph(final Player player) {
		...
		en.step(player, "yes");
		en.step(player, "bye");
		equipWithStackableItem(player, "jabłko", 10);
		equipWithStackableItem(player, "marchew", 10);
		for (int idx = 0; idx < 5; idx++) {
			equipWithItem(player, "mech renifera");
		}
		assertEquals(5, player.getNumberOfEquipped("mech renifera"));
		en.step(player, "hi");
		en.step(player, "yes");
		en.step(player, "bye");
		assertEquals("done", player.getQuest(questSlot, 0));
	...
	public static void doQuestHatForMonogenes(final Player player) {
		...
		en.step(player, "yes");
		en.step(player, "bye");
		equipWithItem(player, "skórzany hełm");
		en.step(player, "hi");
		en.step(player, "yes");
		en.step(player, "bye");
		assertEquals("done", player.getQuest(questSlot, 0));
	...
	public static void doQuestHerbsForCarmen(final Player player) {
		...
		en.step(player, "ingredients");
		en.step(player, "yes");
		equipWithItem(player, "borowik");
		en.step(player, "borowik");
		equipWithItem(player, "pieczarka");
		en.step(player, "pieczarka");
		equipWithStackableItem(player, "arandula", 5);
		en.step(player, "arandula");
		equipWithStackableItem(player, "jabłko", 3);
		en.step(player, "jabłko");
		equipWithStackableItem(player, "polano", 2);
	...
	public static void doQuestKillMonks(final Player player) {
		...
		en.step(player, "quest");
		en.step(player, "yes");
		player.setSoloKillCount("mnich", player.getSoloKillCount("mnich") + 25);
		player.setSoloKillCount("mnich ciemności", player.getSoloKillCount("mnich ciemności") + 25);
		en.step(player, "done");
		en.step(player, "bye");
	}
	...
	public static void doQuestMeetHayunn(final Player player) {
		...
		en.step(player, "hi");
		en.step(player, "bye");
		player.incSoloKillCount("szczur");
		en.step(player, "hi");
		en.step(player, "yes");
		en.step(player, "hi");
		en.step(player, "yes");
