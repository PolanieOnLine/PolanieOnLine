...
public class EntityViewFactory {
	...
	private static void configure() {
		...
		register("item", "book", "bestiariusz", UseableGenericItem2DView.class);
		register("item", "book", "spis", UseableGenericItem2DView.class);
		register("item", "box", null, Box2DView.class);
		register("item", "club", "kij przywoływania nieumarłych", UseableItem2DView.class);
		register("item", "drink", null, UseableItem2DView.class);
		register("item", "food", null, UseableItem2DView.class);
		register("item", "furniture", "obraz w drewnianej ramce", UseableItem2DView.class);
		register("item", "misc", "bulwa", UseableItem2DView.class);
		register("item", "misc", "nasiona", UseableItem2DView.class);
		register("item", "misc", "zima zaklęta w kuli", UseableGenericItem2DView.class);
		register("item", "misc", "pluszowy miś", UseableGenericItem2DView.class);
		register("item", "ring", null, Ring2DView.class);
		register("item", "ring", "pierścień powrotu", TeleportationRing2DView.class);
		register("item", "ring", "pierścień szmaragdowy", BreakableRing2DView.class);
		register("item", "ring", "obrączka ślubna", UseableRing2DView.class);
		register("item", "scroll", null, UseableItem2DView.class);
		register("item", "special", "brosza z mithrilu", Item2DView.class);
		register("item", "tool", "młynek", UseableItem2DView.class);
		register("item", "tool", "wykrywacz metali", UseableGenericItem2DView.class);
		register("item", "tool", "obrotowy nożyk", UseableGenericItem2DView.class);
		register("item", "tool", "zwój czyszczący", UseableItem2DView.class);
		register("item", "tool", "młynek do cukru", UseableItem2DView.class);
		...
		register("creature", "ent", "drzewiec", BossCreature2DView.class);
		register("creature", "ent", "drzewcowa", BossCreature2DView.class);
		register("creature", "ent", "uschły drzewiec", BossCreature2DView.class);
