...
public class j2DClient implements UserInterface {
	...
	public j2DClient(final StendhalClient client,
		...
		if (Debug.PRE_RELEASE_VERSION != null) {
			addEventLine(new HeaderLessEventLine("To jest klient testowy wersji wstępnej: " + Debug.VERSION + " - " + Debug.PRE_RELEASE_VERSION, NotificationType.CLIENT));
		}
	...
	private SoundGroup initSoundSystem() {
		...
		group.loadSound("ui/window-fold", "ui/window-fold.ogg", SoundFileType.OGG, false);
		return group;
	}
