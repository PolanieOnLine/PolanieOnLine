	...
	public boolean execute(final String[] params, final String remainder) {
		...
		if (params[0] == null) {
			lines = Arrays.asList(
				...
				"- /teleport <wojownik> <wojownik lub NPC>",
				"- /teleport <wojownik> <obszar> <x> <y>",
				"\t\tTeleportuje określonego #wojownika do wybranego celu albo miejsca.",
				...
				"- /summon <potwór|przedmiot> [<x> <y>] [ilość] [rarity=<common|rare|epic|legendary>] [<stat>-multiplier=<wartość>]",
				"\t\tPrzywołuje określony przedmiot lub potwora. Kwalifikujące się wyposażenie bez rarity otrzymuje losową rzadkość.",
				"- /summonat <wojownik> <slot> [ilość] <przedmiot> [rarity=<common|rare|epic|legendary>] [<stat>-multiplier=<wartość>]",
				"\t\tPrzywołuje określony przedmiot do wskazanego slotu; ilość domyślnie wynosi 1.",
				"- /destroy <obiekt>",
				"\t\tNiszczy obiekt.",
				"* RÓŻNE:",
				"- /jailreport [<wojownik>]",
