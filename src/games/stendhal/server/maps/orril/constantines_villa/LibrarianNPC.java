...
public class LibrarianNPC implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		...
		npc.setDescription("Oto Cameron, wygląda trochę na szalone, ale nie martw się. Jest tylko bibliotekarze z paroma problemami związanymi z jego najważniejszym skrabem.");
