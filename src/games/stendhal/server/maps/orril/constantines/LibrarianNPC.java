...
public class LibrarianNPC implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		...
		npc.setDescription("Oto Cameron, wygląda trochę na szalonego, ale nie martw się. Jest tylko bibliotekarzem z paroma problemami związanymi z jego najważniejszym skrabem.");
