...
public class FireElementalNPC implements ZoneConfigurator {
	/**
	 * Configure a zone.
	 *
	 * @param zone
	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Żywioł płomienia") {
			@Override
		...
		npc.setDescription("Oto żywioł płomienia. Wygląda na przyjazną wobec obcych.");
