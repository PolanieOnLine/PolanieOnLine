	...
	private void buildNPC(StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Diogenes") {
			...
			public void createDialog() {
				...
				addHelp("Nie mogę Ci pomóc, ale ty możesz pomóc PolanieOnLine mówiąc znajomym i pomagając w rozwoju gry! Wejdź na http://www.polanieonline.eu i zobacz jak możesz nam pomóc!");
				addGoodbye();
