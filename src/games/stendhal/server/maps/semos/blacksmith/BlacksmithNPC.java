	...
	private void buildNPC(StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Xoderos") {
			...
			public void createDialog() {
				...
				addReply(Arrays.asList("bobbin", "szpulka do maszyny", "szpulka"),
						"#Handluję narzędziami, ale nie mam szpulek. Są dla mnie zbyt skomplikowane do zrobienia. Spróbuj u krasnali.");
				addReply(Arrays.asList("oil", "can of oil", "olejek"),
						"Rybacy nas w to zaopatrują.");
