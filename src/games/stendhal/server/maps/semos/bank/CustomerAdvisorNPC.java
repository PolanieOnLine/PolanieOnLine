		...
		final SpeakerNPC npc = new SpeakerNPC("Dagobert") {
			...
			public void createDialog() {
				...
				add(ConversationStates.ANY,
						Arrays.asList("vault", "skarbiec", "skarbca"),
						new QuestCompletedCondition("armor_dagobert"),
						ConversationStates.IDLE, null,
						new MultipleActions(
								new PlaySoundAction("keys-1", true),
								new VaultChatAction()));
		
				add(ConversationStates.ANY,
						Arrays.asList("vault", "skarbiec", "skarbca"),
						new QuestNotCompletedCondition("armor_dagobert"),
