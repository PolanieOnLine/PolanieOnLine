	...
	private void buildKuznia(final StendhalRPZone zone) {
		final SpeakerNPC kuznia = new SpeakerNPC("Kowal Andrzej") {
			...
			protected void createDialog() {
				addGreeting("Witaj!");
				addJob("Witaj. Jestem tutejszym kowalem. Jako specjalne #zadanie mogę zrobić dla Ciebie #złotą #ciupagę lub odlać żelazo.");
				addHelp("Odlewam żelazo oraz w ramach specjalnego zadania wykonuje #złotą #ciupagę.");
				...
				addReply(Arrays.asList("złota ciupaga", "złotą ciupagę"),
						"Podejmę się #zadania wykonania złotej ciupagi o ile posiadasz #ciupagę, #polana, #sztabki #złota i #money. Jestem trochę zapracowany i gdy przyjdziesz to przypomnij mi mówiąc 'przypomnij'.");
				addReply(Arrays.asList("ciupaga", "ciupagę"),
						"Ciupaga to ulubiona broń zbójców w Zakopanem.");
				addReply("polano",
						"Polano znajdziesz na obrzeżach lasów. Potrzebne mi są do podtrzymywania ognia czy wykonania rękojeści.");
				addReply("sztabka złota",
