...
public class GuessKills extends AbstractQuest {
	...
	public List<String> getHistory(final Player player) {
		...
		res.add(player.getGenderVerb("Spotkałem") + " Crearid. Jest starszą panią w mieście Nalwor.");
		res.add("Zapytała mnie, abym zgadł ile razy " + player.getGenderVerb("zabiłem") + " potwora zwanego " + Grammar.pluralCreature(creature) + ".");
