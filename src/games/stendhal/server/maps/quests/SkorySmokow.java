/***************************************************************************
 *                   (C) Copyright 2017-2021 - Stendhal                    *
 ***************************************************************************
 ***************************************************************************
 *                                                                         *
...
public class SkorySmokow extends AbstractQuest {
	...
	private final SpeakerNPC npc = npcs.get("Aligern");
	...
	public List<String> getHistory(final Player player) {
		...
		res.add(player.getGenderVerb("Spotkałem") + " Aligerna w chatce na plaży w Gdańsku.");
		...
		if (questState.equals("done")) {
			res.add(player.getGenderVerb("Zabiłem") + " smoki jak i " + player.getGenderVerb("zaniosłem") + " potrzebne Aligern'owi skóry smoków. W podzięce dał mi swój klucz. Powiedział, że służy on do otwarcia drzwi, które znadują się po prawej stronie i dalej można zejść do jego Wielkiego Mistrza.");
		}
		return res;
	}
