...
public class KoboldishTorcibud extends AbstractQuest {
	...
	private final SpeakerNPC npc = npcs.get("Wrviliza");
	...
	public void phase_1() {
		...
		npc.add(ConversationStates.IDLE,
			...
			"Hau! Witam ponownie... Wróciłeś, aby mi pomóc w przyniesieniu #składników do zrobienia dobrej #nalewki?",
			null);
	...
	public List<String> getHistory(final Player player) {
		...
		res.add("Zawarłem znajomość z koboldką Wrviliza barmanką w barze w Wo'fol.");
