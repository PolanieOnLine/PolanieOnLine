...
public class ObsidianKnife extends AbstractQuest {
	...
	private void requestBookStep() {
		...
		npc.add(ConversationStates.QUEST_ITEM_BROUGHT,
				...
				null,
				ConversationStates.QUEST_ITEM_BROUGHT,
				"Jest ona o kamieniach i minerałach. Założę się byłbyś zainteresowany... sądzisz, że mógłbyś ją zdobyć?",
				null);
	...
	public List<String> getHistory(final Player player) {
		...
		res.add(player.getGenderVerb("Spotkałem") + " Alrak w kuźni w Wofol.");
		...
		res.add(player.getGenderVerb("Przyniosłem") + " Alrakowi jedzenie.");
		...
		res.add(player.getGenderVerb("Zabiłem") + " czarnego smoka.");
		if (questState.equals("knife_offered")
				&& player.hasKilled("czarny smok")) {
			return res;
		}
		res.add(player.getGenderVerb("Przyniosłem") + " dorsza i obsydian.");
		if (questState.equals("knife_offered")
				&& player.isEquipped("obsydian")
				&& player.isEquipped(FISH))  {
			return res;
		}
		res.add(player.getGenderVerb("Zaniosłem") + " dorsza i obsydian do Alrak. Teraz wyrabia mój nóż.");
