...
final class AdosHouseSeller extends HouseSellerNPCBase {
	...
	private void init() {
		...
		addJob("Jestem agentem nieruchomości, po prostu sprzedaje domy w Ados. Zapytaj o #cenę jeżeli jesteś zainteresowany. Nasz katalog domów znajduje się na #'https://s1.polanieonline.eu/wiki/PolanieOnLine_Domki'.");
