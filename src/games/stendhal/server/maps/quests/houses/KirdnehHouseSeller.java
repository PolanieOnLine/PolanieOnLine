...
final class KirdnehHouseSeller extends HouseSellerNPCBase {
	...
	private void init() {
		...
		addJob("Jestem agentem nieruchomości z prostymi zasadami. Sprzedaję domy dla miasta Kirdneh. Zapytaj mnie o #cenę jeżeli jesteś zainteresowany. Nasza broszura znajduje się na #http://www.polanieonline.eu/");
