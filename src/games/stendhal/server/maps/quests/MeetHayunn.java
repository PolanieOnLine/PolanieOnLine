...
public class MeetHayunn extends AbstractQuest {
	...
	private void prepareHayunn() {
		...
		final String epilog = "Na #http://polanieonline.eu możesz znaleźć wiele odpowiedzi listy wszelkiego rodzaju zwierząt, potworów i innych wrogów\n Na #http://polanieonline.eu/node/722 możesz znaleźć informacje o punktach doświadczenia i zdobywaniu poziomów\nNa #http://polanieonline.eu możesz poczytać o najlepszych wojownikach\n ";
