	...
	private void buildNPC(StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Lena") {
			...
			public void createDialog() {
				...
				addHelp("Chleb jest bardzo dobry, zwłaszcza dla takiego śmiałka jak ty, któremu już niedobrze, gdy widzi surowe mięsiwo. Mój szef Ernest, robi najlepsze kanapki w okolicy!");
				addGoodbye();

		// Lena bakes bread if you bring her flour.
		final Map<String, Integer> requiredResources = new TreeMap<String, Integer>();
		requiredResources.put("mąka", 2);

		final ProducerBehaviour behaviour = new ProducerBehaviour("lena_bake_bread",
