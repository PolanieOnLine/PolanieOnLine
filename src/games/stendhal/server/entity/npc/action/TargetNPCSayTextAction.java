...
public class TargetNPCSayTextAction extends SayTextAction {
	...
	public TargetNPCSayTextAction(final String npcName, final String text, final int range) {
		super(text);
		this.npcName = checkNotNull(npcName);
		this.range = range;
	}
	...
	public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
		...
		if (npc != null) {
			if (range == null) {
				...
				npc.say(StringUtils.substitute(Rand.rand(texts), new PlayerMapAdapter(player)), range);
			}
		} else {
