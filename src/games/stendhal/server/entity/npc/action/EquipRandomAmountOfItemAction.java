...
public class EquipRandomAmountOfItemAction implements ChatAction {
	 ...
	 */
	public EquipRandomAmountOfItemAction(final String item, final int min, final int max, final boolean bind) {
	 ...
	 */
	@Dev
	public EquipRandomAmountOfItemAction(final String item, final int min, final int max, @Dev(defaultValue="1") final int increment, final boolean bind) {
