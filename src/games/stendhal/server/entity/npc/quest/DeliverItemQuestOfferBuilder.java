...
public class DeliverItemQuestOfferBuilder extends QuestOfferBuilder<DeliverItemQuestOfferBuilder> {
	protected String respondIfUnableToWearUniform = "Przykro mi, ale nie mam dla ciebie teraz żadnego zadania.";
	...
	protected String respondToAnotherIfNotLostItem = "Wciąż niesiesz ze sobą [item].";
	protected String respondToAnotherIfNoMoney = "Muszę mieć profit z tego, nie mogę ciągle oddawać "
			+ " za darmo [items]. Wróć, gdy będziesz mieć [charge] money.";
