...
public abstract class RPEntity extends CombatEntity {
	...
	private EquipmentEntity entityEquipment;
...
/* ### --- END RANGED --- ### */
	...
	public float getItemAtk() {
		return entityEquipment.getItemAtk();
	}

	public float getItemDef() {
		return entityEquipment.getItemDef();
	}

	public float getItemRatk() {
		return entityEquipment.getItemRatk();
	}

	public List<Item> getDefenseItems() {
		return entityEquipment.getDefenseItems();
	}

	public List<Item> getWeapons() {
		return entityEquipment.getWeapons();
	}

	public Item getWeapon() {
		return entityEquipment.getWeapon();
	}

	public Item getRangeWeapon() {
		return entityEquipment.getRangeWeapon();
	}

	public Item getProjectileLauncher() {
		return entityEquipment.getProjectileLauncher();
	}

	public Item getWandWeapon() {
		return entityEquipment.getWandWeapon();
	}

	public StackableItem getAmmunition() {
		return entityEquipment.getAmmunition();
	}

	public StackableItem getSpells() {
		return entityEquipment.getMagicSpells();
	}

	public StackableItem getMissile() {
		return entityEquipment.getMissileIfNotHoldingOtherWeapon();
	}

	private float handleEquipmentLifesteal(float sumAll) {
		return entityEquipment.handleEquipmentLifesteal(sumAll);
	}
	
	public void updateItemAtkDef() {
		entityEquipment.updateItemAtkDef();
	}
	...
	public int getMaxRangeForArcher() {
		...
		final StackableItem magicammo = getSpells();
		final StackableItem missiles = getMissile();
	 ...
	 */
	protected double getItemLevelModifier(Item item) {
	...
	public void handleLifesteal(final RPEntity attacker,
		...
		if (attacker instanceof Creature) {
			...
			handleEquipmentLifesteal(sumAll);
		}
