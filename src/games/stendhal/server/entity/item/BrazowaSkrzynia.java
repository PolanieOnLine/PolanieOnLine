...
public class BrazowaSkrzynia extends Box {
	...
	private static final double SINGLE_CHANCE = 100.0 / 29.0;

	private static final List<WeightedDropTable.Entry> DROP_TABLE = List.of(
			new WeightedDropTable.Entry("money", 100.0 * 5 / 29.0, 1, 200),
			new WeightedDropTable.Entry("duży eliksir", 100.0 * 4 / 29.0, 1, 3),
			new WeightedDropTable.Entry("wielki eliksir", 100.0 * 3 / 29.0, 1, 3),
			new WeightedDropTable.Entry("gigantyczny eliksir", 100.0 * 2 / 29.0, 1, 3),
			new WeightedDropTable.Entry("maczuga", 100.0 * 2 / 29.0),
			new WeightedDropTable.Entry("skóra zielonego smoka", SINGLE_CHANCE, 1, 3),
			new WeightedDropTable.Entry("skóra niebieskiego smoka", SINGLE_CHANCE, 1, 3),
			new WeightedDropTable.Entry("futro", SINGLE_CHANCE),
			new WeightedDropTable.Entry("korale", SINGLE_CHANCE),
			new WeightedDropTable.Entry("ciupaga", SINGLE_CHANCE),
			new WeightedDropTable.Entry("spodnie kamienne", SINGLE_CHANCE),
			new WeightedDropTable.Entry("kamienna zbroja", SINGLE_CHANCE),
			new WeightedDropTable.Entry("buty kamienne", SINGLE_CHANCE),
			new WeightedDropTable.Entry("sztylet mroku", SINGLE_CHANCE),
			new WeightedDropTable.Entry("kosa", SINGLE_CHANCE),
			new WeightedDropTable.Entry("pyrlik", SINGLE_CHANCE),
			new WeightedDropTable.Entry("skórzane rękawice", SINGLE_CHANCE),
			new WeightedDropTable.Entry("złota kolczuga", SINGLE_CHANCE));
