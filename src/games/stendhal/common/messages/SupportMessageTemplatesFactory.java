...
public class SupportMessageTemplatesFactory {
	...
	private void registerTemplates() {
		...
		addTemplate("$bugstracker","Cześć %s. Wygląda na to, że znalazłeś nowy błąd. Gdybyś mógł zostawić wiadomośc ze szczegółowym opisem jak do tego doszło na #http://polanieonline.eu/bugzilla to byłbym wdzięczny - bardzo dziękuję.");
		addTemplate("$faq", "Cześć. Odpowiedź na swoje pytanie znajdziesz w FAQ, który jest bardzo pomocny więc przeczytaj go uważnie! #http://polanieonline.eu/faq. Dziękujemy, że jesteś z nami!");
		addTemplate("$faqpvp","Witaj %s i przykro słyszeć o tym. Przeczytaj uważnie regulamin dostępny na http://polanieonline.eu/regulamin-gry-mmorpg - powodzenia w przyszłości.");
		...
		addTemplate("$notsupport","Cześć %s. Nie możemy pomóc Tobie w tym problemie. Skorzystaj z #http://polanieonline.eu/bugzilla.");
