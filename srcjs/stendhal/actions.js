...
stendhal.slashActionRepository = {
	...
	"help": {
		execute: function(type, params, remainder) {
			var msg = [
				"For a detailed reference, visit #https://xyz.org/help",
...
/*				"- /profile [name] \tOpens a player profile page on xyz.org.",
				"* PLAYER CONTROL:",
	...
	"atlas": {
		execute: function(type, params, remainder) {
			window.location = "https://xyz.org/world/atlas.html?me="
	...
	"characterselector": {
		execute: function(type, params, remainder) {
			window.location = "https://xyz.org/account/mycharacters.html";
		},
		getMinParams: 0,
		getMaxParams: 0
	},
